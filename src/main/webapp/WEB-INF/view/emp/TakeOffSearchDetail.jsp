				...
				<tbody>
					<c:forEach var="takeoffs" items="${TakeOfffilter}">
						<tr>
							...
							<td
								style="${takeoffs.verifyState == 0 ? 'color: red;' : (takeoffs.verifyState == 2 ? 'color: black;' : (takeoffs.verifyState == 1 ? 'color: blue;' : ''))} ">
							...
							<td><c:choose>
									...
									<c:otherwise>
										<a
											href="http://localhost:8080/ManagementSystem/app/overtime/show/${takeoffs.formId}"
											class="btn align-items-center"
