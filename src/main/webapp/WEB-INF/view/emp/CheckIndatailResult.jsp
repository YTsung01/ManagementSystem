				...
				<tbody>
					...
					<c:forEach var="checkin" items="${CheckInfilter}">
						<tr>
							...
							<td
								style="color: ${checkin.checkInTime.hours > 8 || checkin.checkInTime.hours < 18 ? 'black' : 'red'};">
								<fmt:formatDate value="${ checkin.checkInTime  }"
									pattern="yyyy-MM-dd HH:mm:ss" />
							</td>
							<td
								style="color: ${checkin.checkOutTime.hours > 8 || checkin.checkOutTime.hours < 18 ? 'black' : 'red'};">
