...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
    ...
    @media print {
        <%-- 如果 Systemheader.jsp 包含在 id 为 'systemHeader' 的元素中，使用以下选择器 --%>
        #systemHeader {
            display: none;
        }
    }
...
<div class="container-xl mt-5">
	...
	<div class="d-flex justify-content-center mx-auto p-6 ">
		<div class="border rounded mx-auto px-4  position-relative">
			...
			<button id="printButton" class="btn position-absolute top-10 start-20 " style="background-color: #e3f2fd">列印</button>

			<p class="fs-6 fw-bold text-end">

				<img
					src="${pageContext.request.contextPath}/images/qrcodes/${overTime.formId}.png"
			...
			<div class="p-3">
				<table class="table table-bordered common-table " id="table1">
					<tbody>
						...
						<td colspan="1" width="200px" align='center' valign="middle"> ${overTime.applyHour}&nbsp;小時</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td width="200px" colspan="1"><fmt:formatDate value="${overTime.startTime}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
							<th width="100px" align='center' valign="middle">結束日期</th>
							<td width="200px" colspan="1"><fmt:formatDate value="${overTime.endTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
