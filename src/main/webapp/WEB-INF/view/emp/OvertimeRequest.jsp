		...
		<div class="row">
			...
			<div class="row align-items-center pe-4 mb-3">
				...
				<div class="col-12 col-md-8">
					<label> <input type="radio" name="overTimeType1"
						id="overTimeType" class="form-check-input" value=" 先生" required>
						加班費 <!-- required是設定為必填項目 -->
					</label> <label class="ms-3"> <input type="radio"
						name="overTimeType2" id="a_sex_2" class="form-check-input"
						value=" 小姐" required> 補休
					</label>
				</div>
			</div>
			...
			<div class="row align-items-center pe-4 mb-3">
				<div class="col-12 col-md-2 text-md-end text-nowrap p-md-0">申請類型：</div>
				<div class="col-12 col-md-8">
					<label> <input type="radio" name="overTimeTypeForDay1"
						id="overTimeTypeForDay" class="form-check-input" value=" 先生"
						required> 平日加班 <!-- required是設定為必填項目 -->
					</label> <label class="ms-3"> <input type="radio"
						name="overTimeTypeForDay2" id="a_sex_2" class="form-check-input"
						value=" 小姐" required> 假日加班
					</label>
					<button type="button"
